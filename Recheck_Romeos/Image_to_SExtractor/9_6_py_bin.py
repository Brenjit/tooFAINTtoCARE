...
eazy_base_dir = '/Volumes/MY_SSD_1TB/Work_PhD/July-August/CEERS_data/EAZY/eazy-photoz/outputs_z20'
eazy_flux_dir = '/Volumes/MY_SSD_1TB/Work_PhD/July-August/CEERS_data/EAZY/eazy-photoz/inputs/Results_22nd_Sept/Eazy_catalogue_of_sept_data'
output_dir = './9_6_high_z_catalogues_for_nmad'
...
def main():
    ...
    for pointing in pointings:
        ...
        binned_sources = bin_redshifts_and_select(eazy_zdata, redshift_bins, n_selected=20)
