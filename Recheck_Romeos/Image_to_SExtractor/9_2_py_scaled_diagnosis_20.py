...
output_base_dir = './9_2_new_Diagnostic_Analysis_scaled_20'
...
# Scaling factors for each pointing and filter (updated with new values)
scaling_factors = {
    'nircam1': {
        'f606w': 0.64078, 'f814w': 0.67014, 'f115w': 0.31859, 'f150w': 0.30640,
        'f200w': 0.39484, 'f277w': 0.30098, 'f356w': 0.56230, 'f410m': 0.37613, 'f444w': 0.55014
    },
    'nircam2': {
        'f606w': 0.67021, 'f814w': 0.93389, 'f115w': 0.24789, 'f150w': 0.43880,
        'f200w': 0.27381, 'f277w': 0.29432, 'f356w': 0.60433, 'f410m': 0.44022, 'f444w': 0.33768
    },
    'nircam3': {
        'f606w': 0.58768, 'f814w': 0.86776, 'f115w': 0.19225, 'f150w': 0.35738,
        'f200w': 0.33384, 'f277w': 0.38794, 'f356w': 0.40691, 'f410m': 0.61683, 'f444w': 0.47832
    },
    'nircam4': {
        'f606w': 0.38953, 'f814w': 0.80002, 'f115w': 0.48774, 'f150w': 0.19447,
        'f200w': 0.31739, 'f277w': 0.23027, 'f356w': 0.41359, 'f410m': 0.90503, 'f444w': 0.43099
    },
    'nircam5': {
        'f606w': 0.47241, 'f814w': 0.71325, 'f115w': 0.17390, 'f150w': 0.00090,
        'f200w': 0.00094, 'f277w': 0.00052, 'f356w': 0.15573, 'f410m': 0.00077, 'f444w': 0.00047
    },
    'nircam6': {
        'f606w': 0.92302, 'f814w': 0.87820, 'f115w': 0.34461, 'f150w': 0.43346,
        'f200w': 0.37556, 'f277w': 0.51897, 'f356w': 0.41882, 'f410m': 0.54705, 'f444w': 0.49683
    },
    'nircam7': {
        'f606w': 0.91772, 'f814w': 0.79591, 'f115w': 0.24858, 'f150w': 0.00128,
        'f200w': 0.00108, 'f277w': 0.00090, 'f356w': 0.37605, 'f410m': 0.00107, 'f444w': 0.00048
    },
    'nircam8': {
        'f606w': 0.51051, 'f814w': 0.44218, 'f115w': 0.58099, 'f150w': 0.00132,
        'f200w': 0.00121, 'f277w': 0.00102, 'f356w': 0.26697, 'f410m': 0.00072, 'f444w': 0.00072
    },
    'nircam9': {
        'f606w': 0.80728, 'f814w': 0.67745, 'f115w': 0.25067, 'f150w': 0.00168,
        'f200w': 0.00131, 'f277w': 0.00074, 'f356w': 0.31797, 'f410m': 0.00152, 'f444w': 0.00045
    },
    'nircam10': {
        'f606w': 1.16321, 'f814w': 0.58270, 'f115w': 0.40037, 'f150w': 0.48554,
        'f200w': 0.30178, 'f277w': 0.42365, 'f356w': 0.54885, 'f410m': 0.58859, 'f444w': 0.42252
    }
}
...
def setup_logging(output_dir):
    ...
    log_file = os.path.join(output_dir, "diagnostic_analysis_5f_nof410m_SNR>4_veto<4.txt")
